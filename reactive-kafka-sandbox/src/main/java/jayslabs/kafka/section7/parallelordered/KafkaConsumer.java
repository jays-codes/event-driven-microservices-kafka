...
public class KafkaConsumer {
    ...
    private static Mono<Void> batchProcess(GroupedFlux<Integer,ReceiverRecord<String,String>> fluxRecords) {
        return fluxRecords
        .publishOn(Schedulers.boundedElastic())
        .doFirst(() -> log.info("---- Starting batch processing : mod: {} ----", fluxRecords.key()))
